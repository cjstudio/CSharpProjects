...
@"<cjstudio>
  ...
  <Hash>
        ...
        public void addMsgText_Node(string type,string key, string value)
        {
            XmlNode noddata = rootNode.SelectSingleNode("Data");
            XmlElement xeltext = xmlDoc.CreateElement("Text");
        ...
        public void addMsgText_Node(string type, string value)
        {
            XmlNode noddata = rootNode.SelectSingleNode("Data");
            XmlElement xeltext = xmlDoc.CreateElement("Text");
            xeltext.SetAttribute("type", type);
            xeltext.InnerText = value;
            noddata.AppendChild(xeltext);
        }
        ...
        public List<string> getMsgText()
        {
            ...
            XmlNode noddata = rootNode.SelectSingleNode("Data");
            foreach (XmlNode node in noddata.SelectNodes("Text"))
            {
